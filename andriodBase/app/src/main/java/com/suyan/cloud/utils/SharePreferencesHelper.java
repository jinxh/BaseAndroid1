...
public class SharePreferencesHelper {
    ...
    public SharePreferencesHelper(Context context) {
        sharedPreferences = context.getSharedPreferences(default_filename, Context.MODE_PRIVATE);
    }
    ...
    public void putValues(ContentValue... contentValues) {
        ...
        for (ContentValue contentValue : contentValues) {
            ...
            if (contentValue.value instanceof Boolean) {
                editor.putBoolean(contentValue.key,
                        Boolean.parseBoolean(contentValue.value.toString())).commit();
            }
