...
public class QRCodeUtils {
    ...
    public static Bitmap createQRCode(String str, int widthAndHeight) {
        ...
        BitMatrix matrix;
        try {
            matrix = new QRCodeWriter().encode(str,
    ...
    public static boolean createQRImage(String content, int widthPix, int heightPix, Bitmap logoBm, String filePath) {
        ...
        LogUtils.i(TAG, "widthPix: " + widthPix);
        LogUtils.i(TAG, "heightPix: " + heightPix);
    ...
    public static Bitmap createQRImage(Context context, String content, int heightPix, int drawId) {
        try {
            //配置参数
            Map<EncodeHintType, Object> hints = new HashMap<>();
            hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
            ...
            Bitmap logo = BitmapFactory.decodeResource(context.getResources(), drawId, option);
