...
//        }
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = com.suyan.cloud.AppContext.s_instance
                    .getPackageManager()
                    .getPackageInfo(com.suyan.cloud.AppContext.s_instance.getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && com.suyan.cloud.AppContext.s_instance.getExternalCacheDir() != null)
                sDefaultDir = com.suyan.cloud.AppContext.s_instance.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = com.suyan.cloud.AppContext.s_instance.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
