...
import com.bianyin.setpview.bean.StepBean;
...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.stepview_uncompleted_color);//定义默认未完成线的颜色  definition
    ...
    private void init()
    {
        ...
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.stepview_default_icon);//未完成的icon
    }
