package com.bianyin.nicespinner;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.nicespinner_arrow);
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.nicespinner_arrow);
        setArrowDrawableOrHide(arrowDrawable);
    }
    ...
    public void setDropDownEnable(boolean enable) {
        dropDownEnable = enable;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (dropDownEnable && isEnabled() && event.getAction() == MotionEvent.ACTION_UP) {
